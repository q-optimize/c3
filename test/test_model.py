...
confusion_row1 = Quantity(value=val1, min=min, max=max, unit="")
confusion_row2 = Quantity(value=val2, min=min, max=max, unit="")
...
def test_model_eigenfrequencies() -> None:
    assert hdrift[1, 1] - hdrift[0, 0] == freq_q2
    assert hdrift[3, 3] - hdrift[0, 0] == freq_q1
