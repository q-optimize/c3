...
class SNAIL(PhysicalComponent):
    """
    Represents the element in a chip functioning as a SNAIL, i.e. a Flux qubit with a non zero third order nonlinearity.
    ...
    def get_Hamiltonian(self):
        ...
        the Duffing part and the third order nonlinearity with the beta parameter and returns their sum.
