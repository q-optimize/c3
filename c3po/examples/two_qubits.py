"""Creating the 2 qubits 1 drive example."""
...
# Chip and model
def create_chip_model(qubit1_freq, qubit1_anhar, qubit1_lvls,
                      qubit2_freq, qubit2_anhar, qubit2_lvls,
                      g_coupling, coupling_ham, drive_ham,
    ...
    chip_elements = [q1, q2, coupling, drive]
